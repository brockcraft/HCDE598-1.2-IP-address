...
const char* ssid = "your network name"; //service set identifier (network name)
const char* pass = "your network password"; //network password - for UW use no password, verification is by MAC address at UW
